...
/**
 * SAML-EC GSS-API SessionKeyMethod element.
 */
public interface SessionKeyMethod extends SAMLObject, ElementExtensibleXMLObject {

    /** Element local name. */
    public static final String DEFAULT_ELEMENT_LOCAL_NAME = "SessionKeyMethod";
    ...
    public static final String TYPE_LOCAL_NAME = "SessionKeyMethodType";
